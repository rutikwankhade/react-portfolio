...
const HomePage = () => {
    return (
        <div>
            <div className="about">
                <img className="profile" src="https://pbs.twimg.com/profile_images/1325739123060191235/88CkQzSd_400x400.jpg" />
                <h1>Rutik Wankhade</h1>
                <p>I am a frontend developer. I make things for the web. <br /> I write about javascript, my side projects and document my journey.</p>


                <h3>Skills</h3>
                <div>
                    <svg className="skill" viewBox="0 0 128 128">
